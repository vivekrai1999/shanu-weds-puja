  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center text-center gap-10 px-4 pt-4 pb-12">
        ...
        {/* Groom Sang Bride */}
        <div data-animate="fade-up" data-animate-delay="250ms">
        ...
        {/* Day and Date */}
        <div className="text-2xl md:text-3xl" style={{ fontFamily: "'Arya', sans-serif", color: '#FFFFFF' }} data-animate="fade-up" data-animate-delay="350ms">
